...
date: "2026-03-27"
type: "Presidency Desk Brief"
series: "Presidency Desk"
seriesNumber: 5
audience:
  - policymakers
  - media
...
![Ireland's Critical Entities Resilience Framework](/images/charts/cir_fig1.png)
...
Critical Entities must conduct risk assessments within nine months of designation, drawing on the National Risk Assessment. They must implement resilience measures across four components — resistance, reliability, redundancy, and response and recovery — benchmarked against international standards including ISO 22301, ISO 22372, and ISO 27001.
...
![Ireland's CER governance architecture](/images/charts/cir_fig2.png)
...
Member states must submit national strategies and essential services lists to the Commission, and Ireland chairs the Council when compliance divergences become visible. Thus, Ireland can set the expectation for quality of implementation — using its own strategy as a benchmark.
...
![Key CER decisions during Ireland's Presidency](/images/charts/cir_fig3.png)
*Figure 2: Key CER decisions during Ireland's Presidency term (July–December 2026).*

![CER and NIS 2 framework alignment](/images/charts/cir_fig4.png)
...
Ireland should use its Presidency to commission EU-wide guidance on practical alignment of CER and NIS 2 obligations. The Presidency can mandate the CERG and the NIS Cooperation Group to produce joint guidance on unified risk assessment, coordinated incident reporting, aligned supervision, and harmonised resilience metrics.
...
The next MFF should name critical infrastructure resilience as a funded priority domain — distinct from military capability. If the MFF treats resilience as a subset of defence spending, Ireland's 0.2% of GDP makes it irrelevant; if critical infrastructure resilience is a named category, Ireland's geographic position gives it a permanent claim on EU resources.

**This locks in:** Critical infrastructure resilience as a permanent, funded category in the EU budget.

![Cross-border infrastructure coordination pathway](/images/charts/cir_fig5.png)
...
![Active vs passive chairing outcomes](/images/charts/cir_fig6.png)
